...
export class InmuebleImagenController {
  ...
  async find(
    ...
    return this.inmuebleRepository.imagens(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.imagens(id).create(imagen);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.imagens(id).patch(imagen, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.imagens(id).delete(where);
  }
}
